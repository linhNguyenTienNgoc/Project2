...
public class MenuService {
    ...
    public MenuService() {
        try {
            this.productDAO = new ProductDAOImpl(DatabaseConfig.getInstance().getConnection());
            this.categoryDAO = new CategoryDAOImpl(DatabaseConfig.getInstance().getConnection());
        } catch (Exception e) {
